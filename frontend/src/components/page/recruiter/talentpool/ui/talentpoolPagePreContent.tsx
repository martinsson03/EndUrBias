...
import TalentpoolPageContent from "./talentpoolPageContent";

type TalentpoolPagePreContent = {
    jobId: id
};

export default function TalentpoolPagePreContent({ jobId }: TalentpoolPagePreContent) {
